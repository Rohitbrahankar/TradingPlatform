...
//               <Dialog>
//                 <DialogTrigger>
//                   <div className="h-24 w-24 cursor-pointer flex flex-col items-center justify-center hover:text-gray-400">
//                     <UploadIcon />
//                     <span className="text-sm mt-2">Add Money</span>
//                   </div>
//                 </DialogTrigger>
//                 <DialogContent className="bg-gray-900 text-white p-10 border border-gray-700">
//                   <DialogHeader>
//                     <DialogTitle className="text-center text-2xl">
//                       Top Up Your Wallet
//                     </DialogTitle>
...
//               <Card
//                 key={index}
//                 className="bg-gray-900 border border-gray-700 px-5 py-3 flex justify-between items-center"
//               >
//                 <div className="flex items-center gap-5">
//                   <Avatar>
//                     <AvatarFallback>
