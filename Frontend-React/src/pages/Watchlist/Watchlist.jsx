...
const Watchlist = () => {
  ...
  return (
    <div className="pt-8 lg:px-10 bg-gray-900 min-h-screen">
      <div className="flex items-center pt-5 pb-10 gap-5">
        <BookmarkFilledIcon className="h-10 w-10 text-white" />
        <h1 className="text-4xl font-semibold text-white">Watchlist</h1>
      </div>

      <Table className="px-5 lg:px-20 border-t border-x border-b border-gray-700 bg-gray-900 text-white">
        <ScrollArea>
          <TableHeader>
            <TableRow className="sticky top-0 left-0 right-0 bg-gray-800 text-white">
              <TableHead className="py-4">Coin</TableHead>
              <TableHead>SYMBOL</TableHead>
              <TableHead>VOLUME</TableHead>
              <TableHead>MARKET CAP</TableHead>
